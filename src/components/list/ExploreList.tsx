  ...
  return (
    <View style={homeStyles.topHidingContainer}>
      <View style={homeStyles.flexRowCenter}>
        <Pressable 
        style={homeStyles.leftTab(tabSelected===1)}
        // style={[homeStyles.leftTabBase, leftTabStyle(tabSelected===1)]}
        ...
        <Pressable 
        style={homeStyles.rightTab(tabSelected==2)}
          // style={[homeStyles.rightTabBase, rightTabStyle(tabSelected === 2)]}
