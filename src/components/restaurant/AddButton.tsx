...
const AddButton: FC<{ item: any; restaurant: any }> = ({ item, restaurant }) => {
    ...
    return (
        <>
            ...
            <View style={foodStyles.addButtonContainer(cart !== null)}>
                {
                    cart ? (
                        ...
                        <TouchableOpacity
                            ...
                            style={foodStyles.noSelectionContainer}
                            activeOpacity={0.6}
                        ...
                        >
                            <CustomText
                                ...
                                variant='h5'
                                color={Colors.primary}>Add</CustomText>
                            <CustomText
                                variant='h5'
            ...
            {item?.isCustomizable && (
                <CustomText fontFamily='Okra-Medium' style={foodStyles.customizeText}>Custamisable</CustomText>
            )}
        </>
